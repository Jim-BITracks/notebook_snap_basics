...
while (i <= max_int) {
    ...
    sql = ` SELECT TABLE_NAME 
              , CASE WHEN TABLE_NAME = 'APPLICABLE_ROLES' THEN 'GRANTEE,ROLE_NAME'
                     ...
                     WHEN TABLE_NAME = 'FILE_FORMATS' THEN 'FILE_FORMAT_CATALOG,FILE_FORMAT_SCHEMA,FILE_FORMAT_NAME'
                     ...
                     WHEN TABLE_NAME = 'REFERENTIAL_CONSTRAINTS' THEN 'CONSTRAINT_CATALOG,CONSTRAINT_SCHEMA,CONSTRAINT_NAME'
